...
const ReviewComponent = () => {
  ...
  //   const newReview = {
  //     rating: currentReview.rating.toString(),
  //     comment:currentReview.comment.toString(),
  //     postedDate: currentReview.postedDate.toString(),
  //     restaurantID: currentReview.restaurantID.toString(),
  //     customerID : currentReview.customerID.toString(),
